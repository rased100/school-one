...
const Routine = () => {
  return (
    <div className=" flex justify-center items-center dark:bg-gray-800">
      <div className="p-4 text-center   sm:p-8 dark:bg-gray-800 ">
        ...
        <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">
          Kishalaya Biddaniketan Class Routine. Download the Routine today.
        </p>
        <div className="flex items-center justify-center space-y-4">
          <Link
            to=""
            className="flex-1 sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
          >
            <svg
            ...
            <div className="text-left">
              <div className="mb-1 text-xs text-center">School</div>
