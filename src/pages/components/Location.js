    ...
    <div className="px-5" id="Contact">
      <div className="grid grid-cols-1 lg:grid-cols-2  gap-5 py-10">
        <div
          ...
          //
          className=" flex flex-col justify-center items-center rounded-xl bg-base-100 p-10"
        >
          ...
          <p className="text-lg text-left flex">
          ...
          <div className="md:flex justify-center items-center mt-5">
            <p className="text-lg flex justify-center items-center px-3">
              <MdEmail className="mr-2" size={25} />{" "}
              <p className="md:hidden">Email:</p>
            </p>
            <p className="text-lg">kishalayabiddaniketan1994@gmail.com</p>
          </div>
