  ...
  const LINKS = [
    {
      ...
      items: [
        {
          label: "বাংলাদেশ কারিগরি শিক্ষা বোর্ড",
    ...
    },
    {
      ...
      items: [
        { label: "শিক্ষা মন্ত্রণালয়", link: "https://moedu.gov.bd/" },
        {
          label: "মাধ্যমিক ও উচ্চ শিক্ষা বিভাগ",
        ...
        {
          label: "জাতীয় শিক্ষাক্রম ও পাঠ্যপুস্তক বোর্ড",
  ...
  return (
    ...
    <footer className="w-full  pt-20 bg-[#003f88] gradient-background">
        ...
        >
          ...
          <Typography className="">
            <img
              src={logo}
              alt="Logo"
              className="mr-4 cursor-pointer w-[100px] rounded"
            />
          </Typography>
        </div>
            ...
            {LINKS.map(({ id, title, items }) => (
              <ul key={id}>
                ...
                {items.map((item) => (
                  <li key={item.label}>
                    <Typography
                      // Add this line to open in a new tab
                      rel="noopener noreferrer" // Add this line for security
                      color="gray"
                      className=""
                    >
                      <span className="text-xs hover:text-yellow-400 hover:underline text-white">
      ...
      <div className="mt-12 flex w-full  flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-around">
        ...
        >
          &copy; {currentYear} <Link to="">কিশলয় বিদ্যানিকেতন</Link>. All
          Rights Reserved.
        </Typography>
        <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
          <Typography className="opacity-80 transition-opacity hover:opacity-100 text-white">
            <Link to="">
              {" "}
              <svg
                className="h-5 w-5"
