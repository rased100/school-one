...
const ButtonPrimary = (props) => {
  return (
    <Link
      to=""
      className="relative inline-flex items-center justify-center px-4 py-1.5 overflow-hidden font-bold rounded-md shadow-2xl group text-white hover:text-black"
    >
